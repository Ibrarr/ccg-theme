<section class="archive-header">
    ...
    <div class="container px-4">
        <div class="row">
            <h1 class="title"><?php the_field( 'our_work_heading', 'option' ); ?></h1>
            <div class="col-lg-8 col-md-10 intro">
                <p class="statement"><?php echo ccg_statement_closer_html( ccg_statement_lead_html( get_field( 'our_work_description', 'option' ) ) ); ?></p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container px-4">
        <div class="term-container">
            ...
            <div class="term-selector-container">
                <div class="term-selector">Sector / Service</div>
                <div class="term-selector-menu-container">
                    <div class="term-selector-menu">
						...
						echo '<span class="term-header">Service</span>';
						foreach ( $services as $service ) {
							echo '<span class="term-selector-item service" data-value="' . esc_attr( $service->slug ) . '">' . esc_html( $service->name ) . '</span>';
						}
						?>
                    </div>
                </div>
...
<?php
if ( ! get_field( 'our_work_disable_bottom_cta', 'option' ) ) {
	if ( get_field( 'our_work_custom_bottom_cta', 'option' ) ) {
		$custom_link = get_field( 'our_work_custom_bottom_cta_button', 'option' );
		?>
        <section class="bottom-cta">
            ...
            <div class="parallax-bars"
                 id="bar-three"><?php echo file_get_contents( CCG_TEMPLATE_DIR . '/assets/images/bars/green.svg' ) ?></div>
            <div class="container px-4">
                <div class="row justify-content-center">
                    <div class="col-lg-9 col-md-10">
                        <div class="row">
                            <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 second-row">
                                <h3><?php echo ccg_cta_phrase_html( get_field( 'our_work_custom_bottom_cta_title', 'option'  ) ); ?></h3>
								<?php
								if ( get_field( 'our_work_custom_bottom_cta_description', 'option' ) ) {
									echo '<p>' . get_field( 'our_work_custom_bottom_cta_description', 'option' ) . '</p>';
								}
								?>
                            </div>
