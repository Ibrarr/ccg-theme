...
jQuery(document).ready(function ($) {
  ...
  var initialSourceTerm = params.get('sources') || '';
  function loadPosts() {
    if (isLoading) return;
    isLoading = true;
  ...
  function preselectDropdownOptions() {
    function selectTerm(term) {
      var value = term.data('value');
      var text = term.text();
      $('.selected-terms').append('<span class="selected-term source" data-value="' + value + '">' + text + '</span>');
      term.hide();
    }
    if (initialSourceTerm) {
      var sourceTerm = $(".term-selector-item.source[data-value='" + initialSourceTerm + "']");
      if (sourceTerm.length) {
        sources.push(initialSourceTerm);
        selectTerm(sourceTerm);
      }
    }
  }
