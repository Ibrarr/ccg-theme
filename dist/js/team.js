...
var triggerThree = bottomCta ? ".bottom-cta" : "#footer";
...
gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.batch(".person-container", {
  batchMax: 12,
...
jQuery(document).ready(function ($) {
  ...
  $(".headshot").each(function () {
    ...
    image.onload = function () {
      var headshotHeight = $(this).height() - 30;
      $personContainer.find(".details-open .top-section").css("height", headshotHeight);
    };
  });
  $(".person-container").click(function () {
    var $this = $(this);
    var $activeItem = $(".person-container.active");
    var $detailsOpen = $this.find(".details-open");
    ...
    if (!$this.hasClass("active") && !isAnimating) {
      if ($activeItem.length > 0) {
        ...
        $activeItem.find(".details-open").fadeOut(500, function () {
          ...
          var marginHeight = $bio.height() + 60;
