...
gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to("#bar-three", _objectSpread(_objectSpread({}, parallaxBarsConfig), {}, {
  yPercent: -500
}));
}();
// This entry need to be wrapped in an IIFE because it need to be isolated against other entry modules.
...
var featuredSlider = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__["default"]('.featured-slider .splide', {
  type: 'loop',
  pagination: false,
  perPage: 1,
  speed: 1000,
...
jQuery(document).ready(function ($) {
  ...
  var initialTypeTerm = params.get('types') || '';
  function loadPosts() {
    if (isLoading) return;
    isLoading = true;
  ...
  function preselectDropdownOptions() {
    ...
    if (initialTypeTerm) {
      var typeTerm = $(".term-selector-item.type[data-value='" + initialTypeTerm + "']");
      if (typeTerm.length) {
