...
gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to("#bar-one", {
  yPercent: -400,
  ease: "none",
  scrollTrigger: {
    trigger: "self",
...
gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to("#bar-two", {
  yPercent: -300,
  ease: "none",
  scrollTrigger: {
    trigger: ".impact",
...
gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to("#bar-three", {
  yPercent: -200,
  ease: "none",
  scrollTrigger: {
    trigger: ".bottom-cta",
...
gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.batch(".post-content .image img", {
  batchMax: 1,
...
gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.batch(".related-content .article-card", {
  batchMax: 4,
  onEnter: function onEnter(batch) {
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(batch, {
      autoAlpha: 1,
...
jQuery(document).ready(function ($) {
  $('.work-dropdown').click(function (event) {
    var workDropdown = $('.work-dropdown');
    var dropdownMenuContainer = $('.work-dropdown-menu-container');
    var dropdownTop = workDropdown.offset().top;
    var dropdownBottom = dropdownTop + dropdownMenuContainer.outerHeight() + 60;
    ...
    if (dropdownTop < windowScrollTop) {
      ...
      var necessaryScroll = dropdownBottom - $(window).height() + 30;
      window.scrollTo(0, necessaryScroll);
    }
    event.stopPropagation();
  });
  $(document).click(function (event) {
    var $trigger = $(".work-dropdown, .work-dropdown-menu-container");
