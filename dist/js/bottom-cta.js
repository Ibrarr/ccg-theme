...
function triggerAnimations() {
  var bottomBarOne = document.getElementById("bottom-bar-one");
  if (bottomBarOne) {
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(bottomBarOne, {
      yPercent: -100,
      ease: "none",
      scrollTrigger: {
        trigger: "#footer",
  ...
  var bottomBarTwo = document.getElementById("bottom-bar-two");
  if (bottomBarTwo) {
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(bottomBarTwo, {
      yPercent: -400,
      ease: "none",
      scrollTrigger: {
        trigger: "#footer",
  ...
  var bottomBarThree = document.getElementById("bottom-bar-three");
  if (bottomBarThree) {
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(bottomBarThree, {
      yPercent: -200,
      ease: "none",
      scrollTrigger: {
        trigger: "#footer",
