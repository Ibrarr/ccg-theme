...
var headerSlider = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__["default"]('.header-slider .splide', {
  type: 'loop',
  pagination: false,
  arrows: false,
  pauseOnHover: false,
...
var sectorSlider = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__["default"]('.sectors-slider .splide', {
  type: 'slide',
  pagination: false,
  updateOnMove: true,
  cover: true,
...
jQuery(document).ready(function ($) {
  ...
  function moveSlidesToSplide(slideClass) {
    ...
    var $splideList = $servicesSlider.find('.splide__list');
    var $currentSlides = $splideList.children(':not(:first)');
