...
setTimeout(function () {
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to("#bar-four", {
    yPercent: -400,
    ease: "none",
    scrollTrigger: {
      trigger: "#footer",
...
gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.batch(".about-content img", {
  batchMax: 1,
...
jQuery(document).ready(function ($) {
  var aboutSlider = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__["default"]('.about-slider .splide', {
    type: 'slide',
    direction: 'ttb',
    pagination: false,
    arrows: false,
  ...
  aboutSlider.on('mounted', function () {
    $('body').css('display', 'block');
  });
  aboutSlider.mount();
  aboutSlider.on('moved', function () {
  ...
  aboutSlider.on('move', function (newIndex) {
    var $textElement = $('.about-slide');
    var aboutSliderClass = $('.about-slider');
    ...
    aboutSliderClass.addClass("slide-".concat(newIndex + 1));
  });
});
}();
/******/ })()
