...
jQuery(document).ready(function ($) {
  $('.sector-dropdown').click(function (event) {
    ...
    var dropdownMenuContainer = $('.sector-dropdown-menu-container');
    var dropdownTop = sectorDropdown.offset().top;
  ...
  $(document).click(function (event) {
    var $trigger = $(".sector-dropdown, .sector-dropdown-menu-container");
...
var sectorCardSlider = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__["default"]('.sectors-slider .splide', {
  type: 'slide',
  pagination: false,
  updateOnMove: true,
  cover: true,
...
var sectorNameSlider = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__["default"]('.sector-name-slide .splide', {
  type: 'loop',
  direction: 'ttb',
  focus: 'center',
  pagination: false,
