...
jQuery(document).ready(function ($) {
  ...
  function clickHandler(event) {
    ...
    $item.siblings('.menu-item-has-children.active').removeClass('active').each(function () {
      var $sibling = $(this);
  ...
  $('.menu-item-has-children').each(function (index) {
    ...
    var submenuId = $submenu.attr('id') || 'sub-menu-' + index;
...
var recentInsights = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__["default"]('.recent-insights .splide', {
  type: 'rewind',
  pagination: false,
  perMove: 1,
  perPage: 3,
...
var recentInsightsSearch = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__["default"]('.recent-insights-search .splide', {
  type: 'rewind',
  pagination: false,
  perMove: 1,
  perPage: 3,
...
var recentUpdates = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__["default"]('.latest-updates .splide', {
  type: 'rewind',
  pagination: false,
  perMove: 1,
  perPage: 3,
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkccg"] = self["webpackChunkccg"] || [];
